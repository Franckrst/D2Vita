...
Also accepts a console/qemu-relocated address: base 0x02100000 (current pack) or
0x01900000 (builds up to 0.1.6) -> 0x400000. The two windows do not overlap, so
an address names its own era and old reports stay readable."""
...
if 0x02100000 <= va < 0x02A00000: va = va - 0x02100000 + 0x400000
