...
GAME_BASE = 0x03900000      # Game.exe load base in the guest arena since the 2026-09-24
                            # heap raise (0x02100000 from 0.1.7 to 0.1.11-beta5, 0x01900000
                            # up to 0.1.6: read an older report with --game-base <base>)
